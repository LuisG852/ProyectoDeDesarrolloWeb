...
if DATABASE_URL:
    ...
    # Desarrollo
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql+psycopg://supermarkert_user:7q6Fe4qNgvUQr39ioKfIz8c5TgzIePlx@dpg-d49561idbo4c7388lqug-a.oregon-postgres.render.com:5432/supermarket_db_iy8w'
